...
const Contact = () => {
  return (
    <section id="contacts" data-aos="fade-up" className="relative z-10 bg-transparent text-white py-24 px-4 sm:px-8 md:px-16 lg:px-24">
      <div className="relative bg-gradient-to-br from-[#1a1b2e]/90 to-black/90 backdrop-blur-xl border border-white/10 rounded-[2.5rem] mx-auto p-8 sm:p-14 lg:p-20 shadow-[0_20px_60px_rgba(79,70,229,0.2)] overflow-hidden">
        
        {/* Background Glowing Orbs */}
        <div className="absolute top-0 right-0 w-64 h-64 bg-indigo-500/20 rounded-full blur-[80px] -z-10 pointer-events-none translate-x-1/3 -translate-y-1/3"></div>
        <div className="absolute bottom-0 left-0 w-64 h-64 bg-purple-500/20 rounded-full blur-[80px] -z-10 pointer-events-none -translate-x-1/3 translate-y-1/3"></div>
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-16 relative z-10">
          ...
          <div className="w-full lg:w-[45%] space-y-8 text-center lg:text-left">
            <div className="inline-block px-4 py-1.5 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-indigo-300 font-medium text-sm tracking-widest uppercase mb-2">
              Get in touch
            </div>
            ...
            <div className="pt-4">
              <a
                ...
                className="inline-flex items-center gap-3 bg-indigo-600 hover:bg-indigo-500 text-white px-8 py-4 rounded-full text-lg font-medium shadow-[0_0_20px_rgba(79,70,229,0.4)] hover:shadow-[0_0_30px_rgba(79,70,229,0.6)] hover:-translate-y-1 transition-all duration-300"
              >
